...
mysqli_query($con,"INSERT INTO tbl_accounts (acc_name, acc_login, acc_password) VALUES ('Xinger Zeng', 'zengx315', '". sha1($str3)."');");
mysqli_query($con,"INSERT INTO tbl_accounts (acc_name, acc_login, acc_password) VALUES ('Jinhao Chen', 'chen4566', '". sha1($str3)."');");
